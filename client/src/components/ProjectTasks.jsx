...
const ProjectTasks = ({ tasks }) => {
    ...
    const handleStatusChange = async (taskId, newStatus) => {
        try {
            ...
            //  Simulate API call
            await axiosInstance.put('/tasks',{status: newStatus}, {headers: {Authorization : `Bearer ${await getToken()}`}});
    ...
    const handleDelete = async () => {
        try {
            ...
            //  Simulate API call
            await axiosInstance.post('tasks/delete', {taskIds : selectedTasks}, {headers : {Authorization : `Bearer ${await getToken()}`}})
            //await new Promise((resolve) => setTimeout(resolve, 2000));
